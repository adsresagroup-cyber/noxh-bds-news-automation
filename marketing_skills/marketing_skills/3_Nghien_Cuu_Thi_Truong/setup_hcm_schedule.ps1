...
$targetScript = Join-Path $scriptDir "fetch_hcm_news.ps1"
$taskName = "Daily_HCMC_Real_Estate_News_Crawler"
$taskDescription = "Tu dong cao tin tuc bat dong san TP.HCM va viet kich ban video roi up len Google Drive hang ngay (Thu 2 - Thu 7) luc 7h00 sang."

Write-Host "--- THIET LAP LICH CHAY TU DONG TAC VU CAO TIN TUC BDS TP.HCM ---" -ForegroundColor Green
