...
$targetScript = Join-Path $scriptDir "fetch_nghe_an_news.ps1"
$taskName = "Daily_Nghe_An_Real_Estate_News_Crawler"
$taskDescription = "Tu dong cao tin tuc bat dong san Nghe An va viet kich ban video roi up len Google Drive hang ngay (Thu 2 - Thu 7) luc 7h00 sang."

Write-Host "--- THIET LAP LICH CHAY TU DONG TAC VU CAO TIN TUC BDS NGHE AN ---" -ForegroundColor Green
...
# Create Scheduled Task Trigger (Monday to Saturday at 7:00 AM)
# DaysOfWeek: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday
$trigger = New-ScheduledTaskTrigger -Weekly -DaysOfWeek Monday,Tuesday,Wednesday,Thursday,Friday,Saturday -At "7:00 AM"
...
try {
    ...
    Write-Host "Thoi gian chay: Thu 2 - Thu 7 vao luc 7:00 AM." -ForegroundColor Yellow
